package me.jellysquid.mods.sodium.mixin.features.fast_beacon_beams;
...
public class MixinBeaconBlockEntityRenderer {
    ...
    private static long transformAndWriteVertex(long ptr, Matrix4f positionMatrix, float x, float y, float z, int color, float u, float v, int normal) {
        ...
        ModelVertex.write(ptr, transformedX, transformedY, transformedZ, color, u, v, OverlayTexture.DEFAULT_UV, LightmapTextureManager.MAX_LIGHT_COORDINATE, normal);
