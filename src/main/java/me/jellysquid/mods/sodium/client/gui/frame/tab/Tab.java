...
import me.jellysquid.mods.sodium.client.gui.frame.OptionPageFrame;
import me.jellysquid.mods.sodium.client.gui.frame.ScrollableFrame;
...
public record Tab<T extends AbstractFrame>(Text title, Function<Dim2i, T> frameFunction) {
    ...
    public static class Builder<T extends AbstractFrame> {
        ...
        public Tab<ScrollableFrame> from(OptionPage page, Boxed<Integer> verticalScrollBarOffset) {
            return new Tab<>(page.getName(), dim2i -> ScrollableFrame
                    .createBuilder()
                    .setDimension(dim2i)
                    .setFrame(OptionPageFrame
                            .createBuilder()
                            .setDimension(new Dim2i(dim2i.getX(), dim2i.getY(), dim2i.getWidth(), dim2i.getHeight()))
                            .setOptionPage(page)
                            .build())
