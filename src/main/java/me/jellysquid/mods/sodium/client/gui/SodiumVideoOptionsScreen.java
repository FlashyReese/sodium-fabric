...
import me.jellysquid.mods.sodium.client.gui.frame.BasicFrame;
...
public class SodiumVideoOptionsScreen extends Screen {
    ...
    protected void init() {
        ...
        this.frame = /*ScrollFrame.createBuilder()
                .shouldRenderOutline(true)
                .setDimension(new Dim2i(0, 0, this.width / 2, this.height / 2))
                .setFrame(BasicFrame.createBuilder()
                        .setDimension(new Dim2i(0, 0, this.width, this.height))
                        .addChild(dim -> new FlatButtonWidget(new Dim2i(dim.getLimitX() - 213, dim.getLimitY() - 30, 65, 20), "Undo", this::undoChanges))
                        .addChild(dim -> new FlatButtonWidget(new Dim2i(dim.getLimitX() - 144, dim.getLimitY() - 30, 65, 20), "Apply", this::applyChanges))
                        .addChild(dim -> new FlatButtonWidget(new Dim2i(dim.getLimitX() - 75, dim.getLimitY() - 30, 65, 20), "Close", this::onClose))
                        .build())
                .build();*/
