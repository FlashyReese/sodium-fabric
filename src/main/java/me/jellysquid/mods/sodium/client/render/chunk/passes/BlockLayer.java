...
public enum BlockLayer {
    ...
    static {
        ...
        layerMappings.put(RenderLayer.SOLID, BlockLayer.SOLID_MIPPED.ordinal());
        layerMappings.put(RenderLayer.CUTOUT_MIPPED, BlockLayer.SOLID_MIPPED.ordinal());
        layerMappings.put(RenderLayer.CUTOUT, BlockLayer.SOLID.ordinal());
        //layerMappings.put(RenderLayer.getTripwire(), BlockLayer.SOLID.ordinal());//Fixme:
        layerMappings.put(RenderLayer.TRANSLUCENT, BlockLayer.TRANSLUCENT_MIPPED.ordinal());
    }
