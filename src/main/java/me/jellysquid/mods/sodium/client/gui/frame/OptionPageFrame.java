...
import me.jellysquid.mods.sodium.client.util.MoveableDim2i;
...
public class OptionPageFrame extends AbstractFrame {
    ...
    public OptionPageFrame(Dim2i dim, OptionPage page) {
        super(dim);
        this.originalDim = new Dim2i(dim.getX(), dim.getY(), dim.getWidth(), dim.getHeight()); // Clone
        this.page = page;
        this.setupFrame();
        this.buildFrame();
    }
    ...
    public void buildFrame() {
        ...
        for (OptionGroup group : this.page.getGroups()) {
            ...
            for (Option<?> option : group.getOptions()) {
                ...
                ControlElement<?> element = control.createElement(new MoveableDim2i(this.dim, 0, y, this.dim.getWidth(), 18));
    ...
    public static class Builder {
        ...
        public OptionPageFrame build() {
            ...
            return new OptionPageFrame(this.dim, this.page);
        }
    }
}
