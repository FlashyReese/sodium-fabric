...
import net.caffeinemc.sodium.interop.vanilla.vertex.adapters.ModelQuadOverlayAdapter;
        ...
        if (blittable != null) {
            if (blittable.getBufferVertexFormat() == this.getVertexFormat()) {
                ...
                if (this.format == VertexFormats.POSITION_TEXTURE) {
                    return (T) new ModelQuadOverlayAdapter(VanillaVertexFormats.POSITION_TEXTURE.asBlittable()
